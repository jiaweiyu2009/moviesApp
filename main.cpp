...
int main(int argc, char** argv){
  ...
  while (getline (movieFile, line) && parseLine(line, movieName, movieRating)){
    ...
    movieData.insert(movieName, movieRating);
    //cout << movieName << " has rating " << movieRating << endl;
  }
  
  movieData.printPreOrder();

  cout << endl;
  cout << "Best movie is " << movieData.getTitle_HR(argv[3]) << " with rating " << movieData.getRating_HR(argv[3]) << endl;
